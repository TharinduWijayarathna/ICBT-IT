    ...
    <div class="container pt-md-2 pt-lg-3 pt-xl-4">
        <div class="row pb-5 pt-sm-2 mb-lg-2">
            <div class="col-md-12 col-lg-3 pb-2 pb-lg-0 mb-4 mb-lg-0">
                ...
                <p class="fs-sm pb-2 pb-lg-3 mb-3">Tellus non diam morbi quam vel venenatis proin sed. Dolor elementum
                    nunc dictum</p>
                <div class="d-flex">
        ...
        <p class="nav fs-sm mb-0">
            ...
            <a class="nav-link fw-normal p-0 ms-1" href="https://createx.studio/" target="_blank" rel="noopener">Createx
                Studio</a>
        </p>
    </div>
</footer>
